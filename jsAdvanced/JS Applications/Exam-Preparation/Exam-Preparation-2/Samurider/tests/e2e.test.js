...
describe('E2E tests', function () {
    ...
    describe('Home Page [ 5 Points ]', function () {
        it('Show Home page text [ 2.5 Points ]', async function () {
            ...
            await page.waitForSelector(
                'text=Welcome To Samurider Moto Market, Your Premier Destination For Japanese Motorcycles.',
                { timeout: interval }
            );
            expect(
                await page.isVisible('text=Welcome To Samurider Moto Market, Your Premier Destination For Japanese Motorcycles.')
            ).to.be.true;
        });
    ...
    describe('Dashboard Page [ 15 Points ]', function () {
        ...
        it('Check Motorcycles have correct images [ 2.5 Points ]', async function () {
            ...
            const images = await page.$$eval('.motorcycle img', (t) => t.map((s) => s.src));
        ...
        it('Check Motorcycles have correct model [ 2.5 Points ]', async function () {
            ...
            const categories = await page.$$eval('.motorcycle .model', (t) => t.map((s) => s.textContent));
        ...
        it('Check Motorcycles have correct year [ 2.5 Points ]', async function () {
            ...
            const categories = await page.$$eval('.motorcycle .year', (t) => t.map((s) => s.textContent));
        ...
        it('Check Motorcycles have correct mileage [ 2.5 Points ]', async function () {
            ...
            const categories = await page.$$eval('.motorcycle .mileage', (t) => t.map((s) => s.textContent));
        ...
        it('Check Motorcycles have correct contact [ 2.5 Points ]', async function () {
            ...
            const categories = await page.$$eval('.motorcycle .contact', (t) => t.map((s) => s.textContent));
    ...
    describe('CRUD [ 50 Points ]', () => {
        ...
        describe('Details [ 10 Points ]', function () {
            it('Details calls the correct API [ 2.5 Points ]', async function () {
                ...
                let moreInfoButton = await page.waitForSelector(`.motorcycle:has-text("${data.model}") >> .details-btn`, {
                    timeout: interval,
                });
    ...
    describe('BONUS:Search Page [ 15 Points ]', async () => {
        ...
        it('Show results with 2 motorcycles for Guest [ 2.5 Points ]', async () => {
            ...
            const models = await page.$$eval('.motorcycle .model', (t) => t.map((s) => s.textContent));
        ...
        it('Show More info button for Guest [ 2.5 Points ]', async () => {
            ...
            const names = await page.$$eval('.motorcycle .model', (t) => t.map((s) => s.textContent));
